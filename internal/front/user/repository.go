...
import (
	...
	postgres "rerng_addicted_api/pkg/postgres"
	"rerng_addicted_api/pkg/responses"
	utils "rerng_addicted_api/pkg/utils"
...
func (u *UserRepoImpl) Show(userShowRequest UserShowRequest) (*UserResponse, *responses.ErrorResponse) {
	...
	sqlLimit := postgres.BuildPaging(userShowRequest.PageOptions.Page, userShowRequest.PageOptions.Perpage)
